...
public class OPMLServiceTest {
  ...
  void importFeedTest() throws XMLStreamException, InterruptedException {
    var firstFeed = new Feed(-1, 0, "Deutsche Welle: DW.com Deutsch", URI.create("https://rss.dw.com/xml/rss-de-all"),
        URI.create("https://rss.dw.com/xml/rss-de-all"));
    var secondFeed = new Feed(-1, 0, "WIRED", URI.create("https://www.wired.com/feed/rss"),
        URI.create("https://www.wired.com/feed/rss"));
  ...
  void importSingleFolderTest() throws XMLStreamException, InterruptedException {
    var firstFeed = new Feed(-1, 1, "Deutsche Welle: DW.com Deutsch", URI.create("https://rss.dw.com/xml/rss-de-all"),
        URI.create("https://rss.dw.com/xml/rss-de-all"));
    var secondFeed = new Feed(-1, 1, "WIRED", URI.create("https://www.wired.com/feed/rss"),
        URI.create("https://www.wired.com/feed/rss"));
  ...
  void importMultipleTest() throws XMLStreamException, InterruptedException {
    ...
    var secondFeed = new Feed(-1, 1, "WIRED", URI.create("https://www.wired.com/feed/rss"),
        URI.create("https://www.wired.com/feed/rss"));
    var thirdFeed = new Feed(-1, 2, "https://danluu.com/atom.xml", URI.create("https://danluu.com/atom.xml"),
        URI.create("https://danluu.com/atom.xml"));
    var fourthFeed = new Feed(-1, 2, "IT_Fettchen", URI.create("https://it-fettchen.micro.blog/"),
        URI.create("https://it-fettchen.de/rss/"));
    var firstFolder = new Folder(-1, "folder1", null, "f-base");
  ...
  void exportFeedTest() throws ParserConfigurationException, TransformerException {
    ...
    rootFeeds.add(new Feed(1, 0, "Deutsche Welle: DW.com Deutsch", URI.create("https://www.dw.com/de"),
        URI.create("https://feed.dw.com/de")));
    techFeeds.add(new Feed(2, 1, "Arstechnica", URI.create("https://arstechnica.com"),
        URI.create("https://feed.arstechnica.com")));
    techFeeds
        .add(new Feed(3, 1, "Hackaday", URI.create("https://hackaday.com"), URI.create("https://feed.hackaday.com")));
    sportsFeeds.add(new Feed(4, 2, "NFL | The Guardian", URI.create("https://www.theguardian.com/sport"),
        URI.create("https://feed.theguardian.com/sport")));
    sportsFeeds.add(new Feed(5, 2, "www.espn.com - NFL", URI.create("https://www.espn.com/nfl"),
        URI.create("https://feed.espn.com/nfl")));
